...
import type { DeploymentGroupUpdateRequestDeploymentState } from './deploymentGroupUpdateRequestDeploymentState';

export type DeploymentGroupUpdateRequestDeployment = {
  conditions?: Conditions;
  delta_updatable?: boolean;
  /** Firmware UUID */
  firmware?: string;
  state?: DeploymentGroupUpdateRequestDeploymentState;
  notes?: string;
};
