...
export type DeploymentGroupUpdateRequestDeploymentState = typeof DeploymentGroupUpdateRequestDeploymentState[keyof typeof DeploymentGroupUpdateRequestDeploymentState];


export const DeploymentGroupUpdateRequestDeploymentState = {
  on: 'on',
  off: 'off',
} as const;
