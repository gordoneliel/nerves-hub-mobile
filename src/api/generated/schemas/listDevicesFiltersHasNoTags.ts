...
export type ListDevicesFiltersHasNoTags = typeof ListDevicesFiltersHasNoTags[keyof typeof ListDevicesFiltersHasNoTags];


export const ListDevicesFiltersHasNoTags = {
  true: 'true',
  false: 'false',
} as const;
