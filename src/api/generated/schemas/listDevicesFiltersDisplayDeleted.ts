...
export type ListDevicesFiltersDisplayDeleted = typeof ListDevicesFiltersDisplayDeleted[keyof typeof ListDevicesFiltersDisplayDeleted];


export const ListDevicesFiltersDisplayDeleted = {
  include: 'include',
  exclude: 'exclude',
  only: 'only',
} as const;
