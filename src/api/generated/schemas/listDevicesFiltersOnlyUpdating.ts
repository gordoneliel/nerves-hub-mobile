...
export type ListDevicesFiltersOnlyUpdating = typeof ListDevicesFiltersOnlyUpdating[keyof typeof ListDevicesFiltersOnlyUpdating];


export const ListDevicesFiltersOnlyUpdating = {
  true: 'true',
  false: 'false',
} as const;
