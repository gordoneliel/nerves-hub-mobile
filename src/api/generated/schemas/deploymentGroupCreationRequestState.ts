...
export type DeploymentGroupCreationRequestState = typeof DeploymentGroupCreationRequestState[keyof typeof DeploymentGroupCreationRequestState];


export const DeploymentGroupCreationRequestState = {
  on: 'on',
  off: 'off',
} as const;
