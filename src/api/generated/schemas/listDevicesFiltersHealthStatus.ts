...
export type ListDevicesFiltersHealthStatus = typeof ListDevicesFiltersHealthStatus[keyof typeof ListDevicesFiltersHealthStatus];


export const ListDevicesFiltersHealthStatus = {
  healthy: 'healthy',
  unhealthy: 'unhealthy',
  warning: 'warning',
  unknown: 'unknown',
