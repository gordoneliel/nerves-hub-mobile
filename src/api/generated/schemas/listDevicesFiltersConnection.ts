...
export type ListDevicesFiltersConnection = typeof ListDevicesFiltersConnection[keyof typeof ListDevicesFiltersConnection];


export const ListDevicesFiltersConnection = {
  connected: 'connected',
